export default {
    settings: {
      ...
      features: {
        ...
        dailyCheckIn: {
          title: '每日签到',
          description: '向已登录用户提供每日余额奖励和签到日历。默认开启。',
          enabled: '启用每日签到',
          enabledHint: '关闭后侧边栏入口隐藏，签到页面和接口不可访问；历史签到记录保留。',
        },
        availableChannels: {
          title: '可用渠道',
      ...
      security: {
        ...
        ipBlacklistTitle: '网站 IP 黑名单',
        ipBlacklistDescription: '阻止指定 IP 地址或 CIDR 网段访问整个网站。此设置独立于 API Key 的 IP 限制。',
        ipBlacklistAddLabel: '添加网站 IP 黑名单',
        ipBlacklistPlaceholder: '例如 47.92.239.70 或 203.0.113.0/24',
        ipBlacklistAdd: '加入黑名单',
        ipBlacklistHint: '支持 IPv4、IPv6 和 CIDR；添加后立即生效。请勿误封自己的管理地址。',
        ipBlacklistEmpty: '暂未添加黑名单 IP',
        ipBlacklistInvalid: '请输入有效的 IPv4、IPv6 地址或 CIDR 网段。',
        ipBlacklistDuplicate: '该 IP 或网段已经在黑名单中。',
        ipBlacklistRemove: '移除 {ip}',
        ipBlacklistRemoveConfirm: '确定要移除 {ip} 吗？移除后该地址可以再次访问网站。',
        ipBlacklistAdded: 'IP 已加入黑名单',
        ipBlacklistRemoved: 'IP 已从黑名单移除',
        ipBlacklistSaveFailed: '黑名单操作失败'
      },
      panelRateLimit: {
        title: '面板接口限流',
