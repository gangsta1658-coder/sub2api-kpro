export default {
    accounts: {
      ...
      folders: {
        ...
        duplicateName: '已存在同名文件夹',
        createSuccess: '已创建文件夹“{name}”',
        renameSuccess: '文件夹已重命名为“{name}”',
        deleteSuccess: '已删除文件夹“{name}”',
        moveSuccess: '已移动 {count} 个账号',
        deleteConfirm: '确定删除文件夹“{name}”吗？其中 {count} 个账号将移至“未分类”，账号本身不会被删除。',
        partialMove: '部分操作失败：成功 {success} 个，失败 {failed} 个',
        loadFailed: '文件夹加载失败',
        saveFailed: '文件夹保存失败',
        moveFailed: '移动账号失败',
