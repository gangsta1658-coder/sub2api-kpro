export default {
  ...
  dailyCheckIn: {
    ...
    description: 'Check in daily to receive a $0.20 balance reward',
    rewardLabel: 'Today\'s Reward',
    balanceLabel: 'Current Balance',
    statusAvailable: 'Your daily reward is ready',
    statusClaimed: 'Checked in today',
    claim: 'Check In',
    claiming: 'Checking in...',
    claimSuccess: 'Check-in successful. $0.20 has been added.',
    alreadyClaimed: 'Today\'s reward is in your balance. Come back tomorrow.',
    serverDate: 'Check-in Date',
