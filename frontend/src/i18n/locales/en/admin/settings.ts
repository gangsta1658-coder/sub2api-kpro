    ...
    settings: {
      ...
      features: {
        ...
        dailyCheckIn: {
          ...
          description: 'Give signed-in users a daily balance reward and a check-in calendar. Enabled by default.',
          enabled: 'Enable Daily Check-in',
          enabledHint: 'When off, the sidebar entry is hidden and the check-in page and API are unavailable. Existing records are kept.',
        },
        availableChannels: {
      ...
      security: {
        ...
        ipBlacklistTitle: 'Site IP Blacklist',
        ipBlacklistDescription: 'Block selected IP addresses or CIDR ranges from accessing the entire site. This is separate from API key IP restrictions.',
        ipBlacklistAddLabel: 'Add site IP blacklist entry',
        ipBlacklistPlaceholder: 'e.g. 47.92.239.70 or 203.0.113.0/24',
        ipBlacklistAdd: 'Add to blacklist',
        ipBlacklistHint: 'IPv4, IPv6, and CIDR ranges are supported and take effect immediately. Avoid blocking your own admin address.',
        ipBlacklistEmpty: 'No IP addresses are currently blocked',
        ipBlacklistInvalid: 'Enter a valid IPv4, IPv6, or CIDR range.',
        ipBlacklistDuplicate: 'This IP address or range is already blocked.',
        ipBlacklistRemove: 'Remove {ip}',
        ipBlacklistRemoveConfirm: 'Remove {ip} from the blacklist? It will be able to access the site again.',
        ipBlacklistAdded: 'IP address added to the blacklist',
        ipBlacklistRemoved: 'IP address removed from the blacklist',
        ipBlacklistSaveFailed: 'Blacklist operation failed'
      },
      panelRateLimit: {
