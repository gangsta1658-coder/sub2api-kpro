export default {
    accounts: {
      ...
      folders: {
        ...
        createSuccess: 'Created folder "{name}"',
        renameSuccess: 'Renamed folder to "{name}"',
        deleteSuccess: 'Deleted folder "{name}"',
        moveSuccess: 'Moved {count} accounts',
        deleteConfirm: 'Delete folder "{name}"? Its {count} accounts will move to Uncategorized. The accounts will not be deleted.',
        partialMove: 'Some updates failed: {success} succeeded, {failed} failed',
        loadFailed: 'Failed to load folders',
        saveFailed: 'Failed to save folder',
        moveFailed: 'Failed to move accounts',
