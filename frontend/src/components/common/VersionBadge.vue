<template>
  <div class="relative">
    ...
    <template v-if="isAdmin">
      ...
      >
        <span v-if="currentVersion" class="font-medium">{{ currentVersion.startsWith("v") ? currentVersion : "v" + currentVersion }}</span>
        <span
          v-else
        ...
        >
          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <div class="mb-4 text-center">
                <div class="inline-flex items-center gap-2">
                  <span
                    ...
                    >{{ currentVersion.startsWith("v") ? currentVersion : "v" + currentVersion }}</span
                  >
              ...
              <div v-if="updateError" class="space-y-2">
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="text-xs text-red-600/80 dark:text-red-400/80 break-words leading-relaxed">
                      {{ updateError }}
                    </p>
                  </div>
                </div>
              ...
              <div v-else-if="hasUpdate && isReleaseBuild" class="space-y-2">
                <!-- Kpro custom feature protection notice -->
                <div class="rounded-lg border border-amber-200 bg-amber-50/70 p-2.5 text-xs text-amber-800 dark:border-amber-800/50 dark:bg-amber-900/20 dark:text-amber-300">
                  <div class="font-medium mb-1 flex items-center gap-1.5">
                    <Icon name="shield" size="xs" :stroke-width="2" class="text-amber-600 dark:text-amber-400" />
                    <span>Kpro 定制特性保护中</span>
                  </div>
                  <p class="text-[11px] leading-relaxed text-amber-700/90 dark:text-amber-300/90">
                    当前环境包含定制功能（账号分类/签到/留言/IP黑名单等）。官方发版后，请使用无损升级方案平滑更新，避免官方二进制覆盖自定义功能。
                  </p>
                </div>
