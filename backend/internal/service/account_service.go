...
const AccountFolderExtraKey = "account_folder"
const AccountFolderUncategorizedFilter = "__uncategorized__"

type accountFolderFilterContextKey struct{}
...
func WithAccountFolderFilter(ctx context.Context, name string, uncategorized bool) context.Context {
	return context.WithValue(ctx, accountFolderFilterContextKey{}, AccountFolderFilter{
		Name:          name,
		Uncategorized: uncategorized,
	})
}

func AccountFolderFilterFromContext(ctx context.Context) (AccountFolderFilter, bool) {
	filter, ok := ctx.Value(accountFolderFilterContextKey{}).(AccountFolderFilter)
	return filter, ok
}
