...
const (
	...
	SettingKeyIPBlacklist               = "ip_blacklist"                   // 站点级 IP/CIDR 黑名单（JSON 数组）
	...
	// SettingKeyDailyCheckInEnabled controls whether users can access daily check-in.
	// It defaults to enabled so existing deployments keep their current behavior.
	SettingKeyDailyCheckInEnabled = "daily_check_in_enabled"
