...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			checkIn.Use(middleware.FeatureGate(settingService.IsDailyCheckInEnabled))
			{
				checkIn.GET("/calendar", h.User.GetDailyCheckInCalendar)
				checkIn.GET("", h.User.GetDailyCheckIn)
				checkIn.POST("", h.User.ClaimDailyCheckIn)
			}
