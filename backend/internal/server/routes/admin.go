...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/folders", h.Admin.Account.ListFolders)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// Site-wide client IP blacklist.
		adminSettings.GET("/ip-blacklist", h.Admin.Setting.GetIPBlacklist)
		adminSettings.POST("/ip-blacklist", h.Admin.Setting.AddIPBlacklistEntry)
		adminSettings.DELETE("/ip-blacklist/:ip", h.Admin.Setting.DeleteIPBlacklistEntry)
		adminSettings.DELETE("/ip-blacklist", h.Admin.Setting.DeleteIPBlacklistEntry)
		// 流超时处理配置
