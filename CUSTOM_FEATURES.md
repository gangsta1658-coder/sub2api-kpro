...
| 2026-09-24 | 0.2.8 + Kpro Custom | 已部署并验证 | 镜像 `sub2api:0.2.8-custom-20260924`；合并官方 v0.2.8 上游（Antigravity 防 429、裸模型名思考变体映射、prefixItems Schema 清洗、GPT-6 Sol/Luna、Opus 5.5、OpenCode Go 用量等）；保留账号文件夹、每日签到、IP 黑名单、Glass Auth、Agnes 生图、精准测试模型筛选；快照 `/home/ubuntu/backups/sub2api-pre-v0.2.8-20260924-035202`。 |
